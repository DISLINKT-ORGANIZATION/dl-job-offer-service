package dislinkt.jobofferservice.config;

import dislinkt.jobofferservice.security.TokenUtils;
import dislinkt.jobofferservice.security.auth.RestAuthenticationEntryPoint;
import dislinkt.jobofferservice.security.auth.TokenAuthenticationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/job-offer/**").permitAll().antMatchers("/actuator/**").permitAll()
